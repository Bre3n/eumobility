...
return [
    ...
    'timestamp' => 1678970833,
    'checksum' => '71da27db719480c1305aca53bdeeb7e1',
    'files' => [
        'user/localhost/config' => [
            'plugins/simple-cookie' => [
                'file' => 'user/localhost/config/plugins/simple-cookie.yaml',
                'modified' => 1678970779
            ],
            'security' => [
            ...
            'themes/quarkextended' => [
                'file' => 'user/localhost/config/themes/quarkextended.yaml',
                'modified' => 1678970779
            ]
        ],
        'user/config' => [
            ...
            'plugins/simple-cookie' => [
                'file' => 'user/config/plugins/simple-cookie.yaml',
                'modified' => 1678970779
            ],
            ...
            'themes/quarkextended' => [
                'file' => 'user/config/themes/quarkextended.yaml',
                'modified' => 1678970779
            ],
            'versions' => [
        ...
        'user/plugins' => [
            ...
            'plugins/simple-cookie' => [
                'file' => 'user/plugins/simple-cookie/simple-cookie.yaml',
                'modified' => 1678970780
            ],
            'plugins/sitemap' => [
        ...
        'user/themes' => [
            ...
            'themes/quarkextended' => [
                'file' => 'user/themes/quarkextended/quarkextended.yaml',
                'modified' => 1678970780
            ]
        ]
    ],
    'data' => [
        'themes' => [
            ...
            'quarkextended' => [
                ...
                'custom_logo' => [
                    'user/themes/quarkextended/images/logo/logo.png' => [
                        'name' => 'logo.png',
                        'type' => 'image/png',
                        'size' => 22148,
                        'path' => 'user/themes/quarkextended/images/logo/logo.png'
                    ]
                ],
                'custom_logo_mobile' => [
                    'user/themes/quarkextended/images/logo/logo.png' => [
        ...
        'plugins' => [
            ...
            'simple-cookie' => [
                ...
                'palette' => 'gray',
                'layout' => 'edgeless',
                'informations' => '/pl/polityka-prywatnosci-i-cookies',
                'banner_message' => ' ',
                'banner_dismiss' => 'OK',
                'banner_deny' => NULL,
                'banner_accept' => 'OK',
                'banner_policy' => ' Polityka prywatności i cookies.',
                'custom_config' => NULL
            ],
            'sitemap' => [
                'enabled' => true,
            ...
            'core' => [
                'grav' => [
                    ...
                    'history' => [
                        0 => [
                            'version' => '1.7.37.1',
                            'date' => '2022-10-08 19:24:53'
                        ],
                        1 => [
                            'version' => '1.7.39.4',
                            'date' => '2023-03-09 08:31:18'
                        ]
                    ]
                ]
            ]
