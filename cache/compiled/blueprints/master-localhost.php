...
<<<<<<< HEAD
    'timestamp' => 1678879174,
    'checksum' => '6b02488ec0cbdba03fd48870c8a840a4',
=======
<<<<<<< HEAD
<<<<<<< HEAD
    'timestamp' => 1678879023,
    'checksum' => '24d819cf8c27383ccc507e868389cbe5',
=======
    'timestamp' => 1678879047,
    'checksum' => 'e63a246b0b7e47b8fc2593cb99804587',
>>>>>>> 62722dcb2d513564f29bfd4a0db5e7026b2ef648
=======
    'timestamp' => 1678879174,
    'checksum' => '6b02488ec0cbdba03fd48870c8a840a4',
>>>>>>> 4e571f1fef427a689fa979ec07691d5aa13cde38
>>>>>>> 0e1beae9d01e65743c2ec9184602f2232ae5f31a
    'files' => [
...
>>>>>>> 0e1beae9d01e65743c2ec9184602f2232ae5f31a
        ...
        'user/plugins' => [
            ...
            'plugins/simple-cookie' => [
                'file' => 'user/plugins/simple-cookie/blueprints.yaml',
                'modified' => 1678788037
            ],
            'plugins/sitemap' => [
        ...
        'user/themes' => [
            ...
            'themes/quarkextended' => [
                'file' => 'user/themes/quarkextended/blueprints.yaml',
                'modified' => 1678788136
            ]
        ]
    ],
    'data' => [
        'items' => [
            ...
            'plugins.simple-cookie.enabled' => [
                ...
                'name' => 'plugins.simple-cookie.enabled',
                'validation' => 'strict'
            ],
            'plugins.simple-cookie.position' => [
                'type' => 'select',
                'size' => 'medium',
                'label' => 'Position',
                ...
                'name' => 'plugins.simple-cookie.position',
                'validation' => 'strict'
            ],
            'plugins.simple-cookie.compliance' => [
                'type' => 'select',
                'size' => 'medium',
                'label' => 'Compliance',
                'default' => 'info',
                ...
                'name' => 'plugins.simple-cookie.compliance',
                'validation' => 'strict'
            ],
            'plugins.simple-cookie.layout' => [
                'type' => 'select',
                'size' => 'medium',
                'label' => 'Layout',
                'default' => 'edgeless',
                ...
                'name' => 'plugins.simple-cookie.layout',
                'validation' => 'strict'
            ],
            'plugins.simple-cookie.palette' => [
                'type' => 'select',
                'size' => 'medium',
                ...
                'name' => 'plugins.simple-cookie.palette',
                'validation' => 'strict'
            ],
            'plugins.simple-cookie.informations' => [
                'type' => 'text',
                'label' => 'Learn more link',
                'validate' => [
                    'type' => 'text'
                ],
                'name' => 'plugins.simple-cookie.informations',
                'validation' => 'strict'
            ],
            'plugins.simple-cookie.banner_message' => [
                'type' => 'text',
                'label' => 'Message',
                'validate' => [
                    'type' => 'text'
                ],
                'name' => 'plugins.simple-cookie.banner_message',
                'validation' => 'strict'
            ],
            'plugins.simple-cookie.banner_dismiss' => [
                'type' => 'text',
                'label' => 'Dismiss button text',
                'validate' => [
                    'type' => 'text'
                ],
                'name' => 'plugins.simple-cookie.banner_dismiss',
                'validation' => 'strict'
            ],
            'plugins.simple-cookie.banner_deny' => [
                'type' => 'text',
                'label' => 'Deny button text',
                'validate' => [
                    'type' => 'text'
                ],
                'name' => 'plugins.simple-cookie.banner_deny',
                'validation' => 'strict'
            ],
            'plugins.simple-cookie.banner_accept' => [
                'type' => 'text',
                'label' => 'Accept button text',
                'validate' => [
                    'type' => 'text'
                ],
                'name' => 'plugins.simple-cookie.banner_accept',
                'validation' => 'strict'
            ],
            'plugins.simple-cookie.banner_policy' => [
                'type' => 'text',
                'label' => 'Policy link text',
                'validate' => [
                    'type' => 'text'
                ],
                'name' => 'plugins.simple-cookie.banner_policy',
                'validation' => 'strict'
            ],
            'plugins.simple-cookie.custom' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.simple-cookie.custom',
                'validation' => 'strict'
            ],
            'plugins.simple-cookie.custom_config' => [
                'type' => 'textarea',
                'label' => 'Custom config Object',
                'validate' => [
                    'type' => 'textarea'
                ],
                'name' => 'plugins.simple-cookie.custom_config',
                'validation' => 'strict'
            ],
            'plugins.sitemap' => [
                'type' => '_root',
            ...
            'themes.quarkextended.grid-size' => [
                'type' => 'select',
                'label' => 'THEME_QUARK.ADMIN.GRID_SIZE',
                'size' => 'small',
                'options' => [
                ...
                'name' => 'themes.quarkextended.grid-size',
                'validation' => 'loose'
            ],
            'themes.quarkextended.header-transparent' => [
                'type' => 'toggle',
                'label' => 'Transparent',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.quarkextended.header-transparent',
                'validation' => 'loose'
            ],
            'themes.quarkextended.custom_logo' => [
                'array' => true,
                'media_field' => true,
                'validate' => [
                    'type' => 'ignore'
                ...
                'name' => 'themes.quarkextended.custom_logo',
                'validation' => 'loose'
            ],
            'themes.quarkextended.custom_logo_mobile' => [
                'array' => true,
                'media_field' => true,
                'validate' => [
                    'type' => 'ignore'
                ...
                'name' => 'themes.quarkextended.custom_logo_mobile',
                'validation' => 'loose'
            ]
        ],
        'rules' => [
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'simple-cookie' => [
                    'enabled' => 'plugins.simple-cookie.enabled',
                    'position' => 'plugins.simple-cookie.position',
                    'compliance' => 'plugins.simple-cookie.compliance',
                    'layout' => 'plugins.simple-cookie.layout',
                    'palette' => 'plugins.simple-cookie.palette',
                    'informations' => 'plugins.simple-cookie.informations',
                    'banner_message' => 'plugins.simple-cookie.banner_message',
                    'banner_dismiss' => 'plugins.simple-cookie.banner_dismiss',
                    'banner_deny' => 'plugins.simple-cookie.banner_deny',
                    'banner_accept' => 'plugins.simple-cookie.banner_accept',
                    'banner_policy' => 'plugins.simple-cookie.banner_policy',
                    'custom' => 'plugins.simple-cookie.custom',
                    'custom_config' => 'plugins.simple-cookie.custom_config'
                ],
                'sitemap' => [
            ...
            'themes' => [
                ...
                'quarkextended' => [
                    'grid-size' => 'themes.quarkextended.grid-size',
                    'header-transparent' => 'themes.quarkextended.header-transparent',
                    'custom_logo' => 'themes.quarkextended.custom_logo',
                    'custom_logo_mobile' => 'themes.quarkextended.custom_logo_mobile'
                ]
            ]
        ],
        'dynamic' => [
